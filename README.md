...
This approach not increase android dex count because not have common library code, all code is generated 
and uses only standard java library. `This is experimantal library, please, use with caution!`
